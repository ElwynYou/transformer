...
sqoop export --connect jdbc:mysql://http://hadoop-senior.ibeifeng.com:3306/report --username root --password 123456 --table stats_view_depth --export-dir /hive/bigdater.db/stats_view_depth/* --input-fields-terminated-by "\\01" --update-mode allowinsert --update-key platform_dimension_id,data_dimension_id,kpi_dimension_id
